    ...
    public class RegistryServiceTest
    {
        ...
        public void TestInitWithEmptyStorage()
        {
            var config = new ConfigurationBuilder()
                .AddInMemoryCollection(new[] { new KeyValuePair<string, string>("Registry:StoragePath", _tempDir) })
                .Build();
        ...
        public void TestInitWithProvider()
        {
            ...
            var providersPath = Path.Combine(_tempDir, "providers");
            var registryPath = Path.Combine(providersPath, "registry.terraform.io");
            var namespacePath = Path.Combine(registryPath, "hashicorp");
